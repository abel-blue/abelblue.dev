...
const greeting = {
  username: "abel blue",
  title: "Hi all, I'm Abel",
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building Web and Mobile applications with JavaScript / Reactjs / Nodejs / React Native and some other cool libraries and frameworks."
  ),
  resumeLink:
    "https://drive.google.com/file/d/1ofFdKF_mqscH8WvXkSObnVvC9kK7Ldlu/view?usp=s", // Set to empty to hide the button
...
const socialMediaLinks = {
  ...
  gmail: "abelmgetnet@gmail.com",
  gitlab: "https://gitlab.com/abel-blue",
  facebook: "https://www.facebook.com/abel-blue",
  medium: "https://medium.com/@Abel-Blue",
  stackoverflow: "https://stackoverflow.com/users/13123359/abel-m-getnet",
  ...
  schools: [
    {
      ...
      descBullets: [
        "QR Code payment web api for a vending machine",
        "Hardware + Software"
      ]
    }
    // {
  ...
  experience: [
    {
      ...
      descBullets: [
        ...
        "Ability to program in a programming language such as C#, Java (J2EE) and Kotlin",
...
const contactInfo = {
  ...
  number: "+251919395958",
  email_address: "abelmgetnet@gmail.com"
};

// Twitter Section

const twitterDetails = {
  userName: "JavaScriptDaily", //Replace "twitter" with your twitter username without @
  display: true // Set true to display this section, defaults to false
};
